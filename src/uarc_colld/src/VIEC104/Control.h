...
#ifndef UARC_PROTOCOL_VIEC104_CONTROL_H_
#define UARC_PROTOCOL_VIEC104_CONTROL_H_
...
private:
	...
	static const int _ICountMax = 0x7ff0;
	...
	TimerCallback<Control> *_callback_vdata;
...
#endif /* UARC_PROTOCOL_VIEC104_CONTROL_H_ */
