...
#ifndef UARC_PROTOCOL_IEC104_IEC104Subsystem_H_
#define UARC_PROTOCOL_IEC104_IEC104Subsystem_H_
...
class IEC104Subsystem: public Poco::Util::Subsystem, public Poco::Runnable {
public:
	IEC104Subsystem();
	virtual ~IEC104Subsystem();
	...
	friend void addEpollDevice(void *param);
...
private:
	...
	TimerCallback<IEC104Subsystem> 		*_callback_reconnect;
	...
	TimerCallback<IEC104Subsystem>		*_callback_join_reconnect_thread;
...
#endif /* UARC_PROTOCOL_IEC104_IEC104Subsystem_H_ */
